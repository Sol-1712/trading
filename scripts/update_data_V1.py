...
from data.fetch import fetch_funding_rate, fetch_last_ohlcv, fetch_mark_ohlc
from data.store import make_file_path, load_parquet_partitioned, save_partitioned_parquet


### Requires a full rewrite with async, logging, more rigorous
### I think the api caps at 1000 entries per call, so use asycn to call multiple times at once
